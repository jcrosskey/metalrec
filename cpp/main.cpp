...
void usage();
void parseArguments(int argc, char **argv, string & inputSamFile, string & allFileName, UINT64 & minimumOverlapLength, UINT64 & hashStringLength, UINT32 & maxError, float & maxErrorRate, bool & useCoverageDepth);
...
void usage()
{
	std::cout << std::endl
		...
		<< "    -k\thash string length (kmer length)" << std::endl  // hash string length
		<< std::endl
		<< "  [OPTION]" << std::endl
		<< "    -h/--help" << std::endl
...
int main(int argc, char **argv)
{
	...
	parseArguments(argc, argv, inputSamFile, allFileName, minimumOverlapLength, hashStringLength, maxError, maxErrorRate, useCoverageDepth);
